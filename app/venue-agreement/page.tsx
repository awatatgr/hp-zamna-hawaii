...
日程: 日程未定（TBA）（設営 〜 撤収完了）
本番: Day 1 18:00〜03:00、Day 2 18:00〜03:00
想定来場者数: 2,000〜5,000名`,
  },
  {
    title: "第3条 — 使用料及び支払条件",
...
Dates: Date TBA (setup – teardown complete)
Event: Day 1 18:00–03:00, Day 2 18:00–03:00
...
Party A shall indemnify and hold Party B harmless from damages caused by Party A's negligence.`,
 ...
 - Advance neighbor notification is Party A's responsibility`,
  },
  {
    ...
    body: `Party A shall restore the venue to its original condition by teardown date.
