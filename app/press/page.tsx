...
const KEY_FACTS = [
  ...
  { ja_l: "日程", en_l: "Dates", ja_v: "日程未定（TBA）", en_v: "Date TBA" },
        ...
        <motion.section {...fade} style={{ marginBottom: 40 }}>
          ...
          <div className="card" style={{ padding: "24px 28px" }}>
            <p style={{ color: "rgba(255,255,255,0.6)", fontSize: 13, lineHeight: 1.8, fontStyle: "italic" }}>
              {ja
                ? "SOLUNA FEST HAWAIIは、世界最高峰のアンダーグラウンド・エレクトロニック・ミュージックフェスティバル「SOLUNA」の初の米国開催です。日程未定（TBA）、オアフ島モアナルアガーデンにて開催。SOLUNAがプロデュース。詳細: solun.art"
                : "SOLUNA FEST HAWAII is the first-ever US edition of SOLUNA, the world's most premium underground electronic music festival. Date TBA at Moanalua Gardens, Oahu. Produced by SOLUNA. More info: solun.art"}
            </p>
          </div>
        </motion.section>
